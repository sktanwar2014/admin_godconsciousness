...
export default function EventList() {
  ...
  return(
    ...
    {editOpen ? <Update open={editOpen} handleClose = {handleEditClose} rowData = {rowData} setEvents = {setEvents} /> : null}
    {addOpen ? <Add open={addOpen} handleClose = {setAddOpen} setEvents = {setEvents} /> : null}
  </section>
  )
}
