...
export default function EventList() {
  ...
  const fetchDirection = async () => {
    try{
      const result = await APIs.getdirection({});
  ...
  return(
    ...
    {editOpen ? <Update open={editOpen} handleClose = {handleEditClose} rowData = {rowData} setDirections = {setDirections} /> : null} 
    {addOpen ? <Add open={addOpen} handleClose = {setAddOpen} setDirections = {setDirections} /> : null}
  </section>
  )
}
